...
---
↑ Parent: [[Self-Attention]] · Deep dive: [[Self-Attention]] · Related: [[Attention Mechanism]] · [[Transformer]]

# Self-Attention (Beginner Intro)

> [!NOTE]
> This is a beginner-friendly introduction. For the full technical detail — including the math, causal masking, multi-head attention, and the grokking circuit — see [[Self-Attention]].
